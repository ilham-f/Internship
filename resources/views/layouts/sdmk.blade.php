            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/semuamahasiswa" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/mahasiswaku" class="nav-link">
                                <i class="bi bi-people-fill me-3"></i>
                                <p>
                                    MahasiswaKu
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="/semuakebutuhan" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/kebutuhanku" class="nav-link">
                                <i class="bi bi-inboxes-fill me-3"></i>
                                <p>
                                    KebutuhanKu
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="/permohonan" class="nav-link">
                                ...
                                @if (count($permohonanbaru) != 0)
                                    <span class="rounded-pill bg-danger px-2 py-0" style="font-size: 11px">{{ count($permohonanbaru) }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/hasilevaluasi" class="nav-link">
